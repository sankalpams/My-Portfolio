...
export const Hero: React.FC<HeroProps> = ({ onOpenResume }) => {
  ...
  return (
    <section id="overview" className="relative min-h-[92vh] flex items-center pt-28 pb-16 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-6 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start text-left z-20">
            ...
            {/* Top Pill Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-zinc-900/90 dark:bg-zinc-900/90 border border-zinc-800 dark:border-zinc-800 text-zinc-300 dark:text-zinc-300 text-[11px] font-mono tracking-widest uppercase mb-6 shadow-sm">
              <span>DATA SCIENCE & MACHINE LEARNING</span>
            </div>

            {/* Giant Bold Dual-Line Title */}
            <div className="mb-3">
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-display font-black tracking-tight uppercase leading-[0.95] text-white dark:text-white">
                MALITH
              </h1>
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-display font-black tracking-tight uppercase leading-[0.95] bg-clip-text text-transparent bg-gradient-to-r from-rose-200 via-rose-300 to-pink-300 dark:from-rose-200 dark:via-rose-300 dark:to-pink-300">
                SANKALPA
              </h1>
            </div>
          ...
          <div className="lg:col-span-6 flex items-center justify-center relative select-none mt-10 lg:mt-0">
            <div className="relative w-full flex items-center justify-center py-6">
              ...
              <div className="absolute w-[450px] h-[450px] sm:w-[580px] sm:h-[580px] lg:w-[680px] lg:h-[680px] rounded-full bg-gradient-to-tr from-rose-500/30 via-pink-500/20 to-cyan-500/30 blur-3xl -z-10 animate-pulse-glow" />
              ...
              <div className="relative z-10 group w-full flex justify-center items-center">
                <div className="relative [mask-image:linear-gradient(to_bottom,black_86%,transparent_100%)] w-full flex justify-center items-center">
                  <img 
                    ...
                    className="w-[360px] sm:w-[480px] md:w-[560px] lg:w-[640px] xl:w-[720px] max-w-none h-auto object-contain drop-shadow-[0_35px_80px_rgba(244,63,94,0.35)] group-hover:scale-105 transition-all duration-500"
                    onError={(e) => {
