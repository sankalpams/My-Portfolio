...
export const ResumePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen py-24 px-4 sm:px-6 lg:px-8 text-white print:p-0 print:py-0 print:bg-white print:text-black">
      <div className="max-w-4xl mx-auto">
        
        {/* Navigation & Controls (Hidden when printing) */}
        <div className="flex flex-wrap items-center justify-between gap-4 pb-6 mb-8 border-b border-zinc-800 print:hidden">
          <button
            onClick={() => navigate('#/')}
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={handlePrint}
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-zinc-900 hover:bg-zinc-800 text-zinc-200 hover:text-white border border-zinc-700 text-xs font-mono font-medium transition-all hover:scale-105"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-rose-500 hover:bg-rose-400 text-slate-950 font-display font-bold text-xs uppercase tracking-wider transition-all shadow-md shadow-rose-500/20 hover:scale-105"
            >
        ...
        <div className="rounded-3xl bg-[#09090c] border border-zinc-800 p-8 sm:p-12 shadow-2xl space-y-8 font-sans print:border-none print:shadow-none print:p-0 print:bg-transparent print:text-black">
          
          {/* Header */}
          <div className="pb-8 border-b border-zinc-800 print:border-black/20 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div>
              <h1 className="text-3xl sm:text-4xl font-display font-extrabold text-white print:text-black tracking-tight uppercase">
                {personalInfo.name}
              </h1>
              <p className="text-sm font-mono text-rose-400 print:text-zinc-800 font-semibold mt-1">
                Data Science Undergraduate | Machine Learning &amp; Analytics
              </p>

              <div className="flex flex-wrap items-center gap-y-2 gap-x-4 mt-4 text-xs text-zinc-400 print:text-zinc-700 font-mono">
                <span className="flex items-center gap-1">
                  <MapPin className="w-3.5 h-3.5 text-rose-400 print:text-zinc-800" />
                  Ampara, Sri Lanka
                </span>
                <span>•</span>
                <span className="flex items-center gap-1">
                  <Phone className="w-3.5 h-3.5 text-rose-400 print:text-zinc-800" />
                  +94 71 335 0404
                </span>
                <span>•</span>
                <span className="flex items-center gap-1">
                  <Mail className="w-3.5 h-3.5 text-rose-400 print:text-zinc-800" />
                  malithsankalpa52@gmail.com
                </span>
                <span>•</span>
                <span className="flex items-center gap-1">
                  <LinkedinIcon className="w-3.5 h-3.5 text-rose-400 print:text-zinc-800" />
                  linkedin.com/in/malithshehan
                </span>
                <span>•</span>
                <span className="flex items-center gap-1">
                  <GithubIcon className="w-3.5 h-3.5 text-rose-400 print:text-zinc-800" />
          ...
          <div>
            <h2 className="text-xs font-mono uppercase tracking-wider text-rose-400 print:text-zinc-900 font-bold mb-2">
              PROFESSIONAL SUMMARY
            </h2>
          ...
          {/* Technical Skills */}
          <div>
            <h2 className="text-xs font-mono uppercase tracking-wider text-rose-400 print:text-zinc-900 font-bold mb-3 flex items-center gap-1.5">
              <Cpu className="w-4 h-4 print:hidden" />
              TECHNICAL SKILLS
            </h2>

            <div className="space-y-1.5 text-xs text-zinc-300 print:text-zinc-800 font-mono">
              <div><strong className="text-white print:text-black">Programming:</strong> Python, SQL, Java (basic), Dart</div>
              <div><strong className="text-white print:text-black">Machine Learning &amp; Deep Learning:</strong> Scikit-learn, XGBoost, PyTorch, Keras/TensorFlow, Graph Neural Networks (GCN, GAT), LSTM, BERT/Transformers, supervised &amp; unsupervised learning, model evaluation &amp; hyperparameter tuning, explainable AI (SHAP, LIME)</div>
              <div><strong className="text-white print:text-black">Data Analysis &amp; Visualization:</strong> Pandas, NumPy, Exploratory Data Analysis, Feature Engineering, Matplotlib, Seaborn, Power BI, Excel</div>
              <div><strong className="text-white print:text-black">MLOps &amp; Experimentation:</strong> DagsHub (experiment tracking &amp; versioning), reproducible pipelines, GitHub Actions, Streamlit</div>
              <div><strong className="text-white print:text-black">Databases:</strong> MySQL, PostgreSQL (basic), Supabase</div>
              <div><strong className="text-white print:text-black">Cloud / DevOps:</strong> Docker (basic), Git, GitHub</div>
              <div><strong className="text-white print:text-black">Soft Skills:</strong> Leadership, technical communication, problem-solving, adaptability, critical thinking</div>
            </div>
          </div>
            ...
            <div className="space-y-5">
              ...
              <div className="text-xs sm:text-sm">
                <div className="flex flex-wrap justify-between items-baseline">
                  <span className="font-display font-bold text-zinc-100 print:text-black">
                    AI-Based Personalized Financial Coaching &amp; Sandbox Investment Training App (Final Year Project, Ongoing)
                  </span>
                  <span className="text-[11px] font-mono text-rose-400 print:text-zinc-600">
                    Flutter · Dart · Supabase · Python · PyTorch · LSTM · BERT · SHAP/LIME
                  </span>
                </div>
                <ul className="mt-1.5 space-y-1 text-xs text-zinc-300 print:text-zinc-700 pl-4 list-disc">
          ...
          <div>
            ...
            <div className="space-y-2.5 text-xs sm:text-sm">
              <div>
                <div className="flex justify-between font-bold text-zinc-100 print:text-black">
                  <span>BSc (Hons) in Data Science — Sri Lanka Technology Campus (SLTC)</span>
                  <span className="font-mono text-zinc-400 print:text-zinc-600 font-normal">2024 – 2027</span>
                </div>
              </div>
              <div>
                <div className="flex justify-between font-bold text-zinc-100 print:text-black">
                  <span>Diploma in Information Technology — ESOFT Metro Campus</span>
                  <span className="font-mono text-zinc-400 print:text-zinc-600 font-normal">2022 – 2023</span>
                </div>
              </div>
              <div>
                <div className="flex justify-between font-bold text-zinc-100 print:text-black">
              ...
              <div>
                <div className="flex justify-between font-bold text-zinc-100 print:text-black">
                  ...
                  <span className="font-mono text-zinc-400 print:text-zinc-600 font-normal">2022</span>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Certifications */}
          <div>
            <h2 className="text-xs font-mono uppercase tracking-wider text-rose-400 print:text-zinc-900 font-bold mb-2 flex items-center gap-1.5">
              <Award className="w-4 h-4 print:hidden" />
              CERTIFICATIONS
            </h2>
            <div className="space-y-3 text-xs text-zinc-300 print:text-zinc-800">
              {certifications.map((cert) => (
                <div key={cert.id} className="border-l-2 border-zinc-800 print:border-zinc-300 pl-3">
                  <div className="flex flex-wrap items-baseline justify-between gap-1">
                    <span className="font-bold text-white print:text-black">
                      {cert.title} — <span className="text-zinc-400 print:text-zinc-600 font-normal">{cert.issuer}</span>
                    </span>
                    <span className="font-mono text-[11px] text-rose-400 print:text-zinc-600">{cert.issueDate}</span>
                  </div>
