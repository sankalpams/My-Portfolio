  ...
  const getCustomProjectBanner = () => {
    switch (project.id) {
      case 'financial-ai-coaching':
        return (
          <div className="p-6 sm:p-8 rounded-3xl bg-[#0d0e17] border border-rose-500/30 font-mono shadow-2xl relative overflow-hidden">
      ...
      case 'smartcare-hospital-risk':
        return (
          <div className="p-6 sm:p-8 rounded-3xl bg-[#090e14] border border-cyan-500/30 font-mono shadow-2xl relative overflow-hidden">
            <div className="flex flex-wrap items-center justify-between border-b border-zinc-800 pb-4 mb-6 gap-3">
              <div className="flex items-center gap-2.5">
      ...
      case 'ogbn-arxiv-gnn':
        return (
          <div className="p-6 sm:p-8 rounded-3xl bg-[#110d1c] border border-violet-500/30 font-mono shadow-2xl relative overflow-hidden">
            <div className="flex flex-wrap items-center justify-between border-b border-zinc-800 pb-4 mb-6 gap-3">
              <div className="flex items-center gap-2.5">
      ...
      case 'customer-churn-mlops':
        return (
          <div className="p-6 sm:p-8 rounded-3xl bg-[#09120e] border border-emerald-500/30 font-mono shadow-2xl relative overflow-hidden">
            <div className="flex flex-wrap items-center justify-between border-b border-zinc-800 pb-4 mb-6 gap-3">
              <div className="flex items-center gap-2.5">
      ...
      default:
        return (
          <div className="p-6 sm:p-8 rounded-3xl bg-[#141009] border border-amber-500/30 font-mono shadow-2xl relative overflow-hidden">
            <div className="flex flex-wrap items-center justify-between border-b border-zinc-800 pb-4 mb-6 gap-3">
              <div className="flex items-center gap-2.5">
